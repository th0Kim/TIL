...
$(function(){
    ...
    app.init = function(){
        ...
        // 실행
        $('body').find('.btnNext').on("click", app.nextClicked); // 다음 버튼 클릭 이벤트
        $('body').find('.btnPrev').on("click", app.prevClicked); // 이전 버튼 클릭 이벤트
        $('body').find('.btnCountCtrl').on("click", app.indiClicked); // indi 클릭 이벤트
